...
import com.muhmmad.cryptotracker.crypto.presentation.coin_details.components.InfoCard
import com.muhmmad.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.muhmmad.cryptotracker.crypto.presentation.models.toDisplayNumber
import com.muhmmad.cryptotracker.ui.theme.greenBackground
        ...
        Column(
            ...
            FlowRow(
                ...
                val absoluteChangeFormatted =
                    (coin.priceUsd.value * (coin.changePercent24Hr.value / 100)).toDisplayNumber()
            ...
            AnimatedVisibility(visible = coin.coinPriceHistory.isNotEmpty()) {
                ...
                LineChart(
                    ...
                    style = ChartStyle(
                        ...
                        verticalPadding = 8.dp, horizontalPadding = 8.dp, xAxisLabelSpacing = 8.dp,
                    ),
